...
pub(super) fn message_attribute(source: &str) -> Option<(&'static str, &'static str)> {
    match source {
        ...
        "Browse..." => Some(("insert", "pdfui-browse")),
        "Select one or more pages from the PDF file:" => Some(("insert", "pdfui-select-one-or-more-pages-from-the-pdf-file")),
        "Insertion point" => Some(("insert", "pdfui-insertion-point")),
        "Angle:" => Some(("insert", "pdfui-angle")),
        "Found in:" => Some(("insert", "pdfui-found-in")),
        "Saved path:" => Some(("insert", "pdfui-saved-path")),
        "Page size:" => Some(("insert", "pdfui-page-size")),
        "Hide Details" => Some(("insert", "pdfui-hide-details")),
        "Show Details" => Some(("insert", "pdfui-show-details")),
