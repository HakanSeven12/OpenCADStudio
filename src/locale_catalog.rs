...
pub(super) fn message_attribute(source: &str) -> Option<(&'static str, &'static str)> {
    match source {
        ...
        "Block Unit" => Some(("insert", "xref-attach-block-unit")),
        "Unit:" => Some(("insert", "xref-attach-unit")),
        "Factor:" => Some(("insert", "xref-attach-factor")),
        "Found in:" => Some(("insert", "xref-attach-found-in")),
        "Saved path:" => Some(("insert", "xref-attach-saved-path")),
        "Show Details" => Some(("insert", "xref-attach-show-details")),
        "Hide Details" => Some(("insert", "xref-attach-hide-details")),
        "Select Reference File" => Some(("insert", "xref-attach-select-file")),
        "All Reference Files" => Some(("insert", "xref-attach-all-files")),
        "Inserts references to external files such as other drawings, raster images, and underlays." => Some(("insert", "xref-attach-help")),
        "Invalid input." => Some(("insert", "xref-attach-invalid-input")),
        "Insertion point X" => Some(("insert", "xref-insertion-point-x")),
        "Insertion point Y" => Some(("insert", "xref-insertion-point-y")),
        "Insertion point Z" => Some(("insert", "xref-insertion-point-z")),
        "Layer property overrides" => Some(("insert", "xref-layer-property-overrides")),
        ...
        "Snap to Underlays" => Some(("insert", "refui-snap-to-underlays")),
        ...
        "PDF Underlay" => Some(("properties", "pdf-underlay")),
        "DWF Underlay" => Some(("properties", "dwf-underlay")),
        "DGN Underlay" => Some(("properties", "dgn-underlay")),
        "Adjust colors for background" => Some(("properties", "adjust-colors-for-background")),
        "Page number" => Some(("properties", "page-number")),
        "Layer display overrides" => Some(("properties", "layer-display-overrides")),
        "Display in\nMonochrome" => Some(("insert", "pdfui-display-in-monochrome")),
        "Create Clipping\nBoundary" => Some(("insert", "pdfui-create-clipping-boundary")),
        "Remove\nClipping" => Some(("insert", "pdfui-remove-clipping")),
        "Show\nUnderlay" => Some(("insert", "pdfui-show-underlay")),
        "Enable\nSnap" => Some(("insert", "pdfui-enable-snap")),
        "External\nReferences" => Some(("insert", "pdfui-external-references")),
        "Edit\nLayers" => Some(("insert", "pdfui-edit-layers")),
        "Import As\nObjects" => Some(("insert", "pdfui-import-as-objects")),
        "PDF Layers" => Some(("insert", "pdfui-pdf-layers")),
        "PDF Import" => Some(("insert", "pdfui-pdf-import")),
        "Attach PDF Underlay" => Some(("insert", "pdfui-attach-pdf-underlay")),
        "Underlay Layers" => Some(("insert", "pdfui-underlay-layers")),
        "PDF Import Settings" => Some(("insert", "pdfui-pdf-import-settings")),
        "Import PDF" => Some(("insert", "pdfui-import-pdf")),
        "Select one or more pages from the PDF file:" => Some(("insert", "pdfui-select-one-or-more-pages-from-the-pdf-file")),
        ...
        "Solid fills" => Some(("insert", "pdfui-solid-fills")),
        "TrueType text" => Some(("insert", "pdfui-truetype-text")),
        "Raster images" => Some(("insert", "pdfui-raster-images")),
        "Use PDF layers" => Some(("insert", "pdfui-use-pdf-layers")),
        "Create object layers" => Some(("insert", "pdfui-create-object-layers")),
        "Import options" => Some(("insert", "pdfui-import-options")),
        "Import as block" => Some(("insert", "pdfui-import-as-block")),
        "Join line and arc segments" => Some(("insert", "pdfui-join-line-and-arc-segments")),
        "Convert solid fills to hatches" => Some(("insert", "pdfui-convert-solid-fills-to-hatches")),
        "Apply lineweight properties" => Some(("insert", "pdfui-apply-lineweight-properties")),
        "Infer linetypes from collinear dashes" => Some(("insert", "pdfui-infer-linetypes-from-collinear-dashes")),
        "Page to import" => Some(("insert", "pdfui-page-to-import")),
        "Page:" => Some(("insert", "pdfui-page")),
        "Total: {count}" => Some(("insert", "pdfui-total-count")),
        "Pages" => Some(("insert", "pdfui-pages")),
        "Placement" => Some(("insert", "pdfui-placement")),
        "On screen" => Some(("insert", "pdfui-on-screen")),
        "File details" => Some(("insert", "pdfui-file-details")),
        "{count} pages" => Some(("insert", "pdfui-page-count")),
        "Selected pages: {pages}" => Some(("insert", "pdfui-selected-pages")),
        "{count} layers, {hidden} hidden" => Some(("insert", "pdfui-layer-summary")),
        "Page size: {size}" => Some(("insert", "pdfui-page-size-size")),
        "Specify insertion point on-screen" => Some(("insert", "pdfui-specify-insertion-point-on-screen")),
        "Scale:" => Some(("insert", "pdfui-scale")),
        "Rotation:" => Some(("insert", "pdfui-rotation")),
        "Attaches a PDF file as an underlay." => Some(("insert", "pdfui-attaches-a-pdf-file-as-an-underlay")),
        "Turns the layers of a PDF underlay on or off." => Some(("insert", "pdfui-turns-the-layers-of-a-pdf-underlay-on-or-off")),
        "Imports the geometry, fills, raster images and text of a PDF file as drawing objects." => Some(("insert", "pdfui-imports-the-geometry-fills-raster-images-and-text-of-a-pdf-f")),
        "Select PDF File" => Some(("insert", "select-pdf-file")),
        ...
        "Allow exploding" => Some(("common", "allow-exploding")),
        "Angstroms" => Some(("common", "angstroms")),
        "Astronomical Units" => Some(("common", "astronomical-units")),
        "BLOCK  Select objects:" => Some(("insert", "block-select-objects")),
        "BLOCK  Specify insertion base point:" => Some(("insert", "block-specify-insertion-base-point")),
        "BLOCK creates a block definition from objects you select." => Some(("common", "block-creates-a-block-definition-from-objects-you-select")),
        "Behavior" => Some(("common", "behavior")),
        "Block \"{name}\" already exists.\nDo you want to redefine it?" => Some(("common", "block-name-already-exists-do-you-want-to-redefine-it")),
        "Block \"{}\" already exists — will redefine upon OK" => Some(("common", "block-already-exists-will-redefine-upon-ok")),
        "Block Definition" => Some(("common", "block-definition")),
        "Block name" => Some(("common", "block-name")),
        "Block name cannot be empty." => Some(("common", "block-name-cannot-be-empty")),
        "Block name cannot contain: \\ / : * ? \" < > | = `" => Some(("common", "block-name-cannot-contain-invalid-chars")),
        "Block name cannot start with '*'." => Some(("common", "block-name-cannot-start-with-star")),
        "Block unit:" => Some(("common", "block-unit-label")),
        "Convert to block" => Some(("common", "convert-to-block")),
        "Decameters" => Some(("common", "decameters")),
        "Decimeters" => Some(("common", "decimeters")),
        "Enter block description..." => Some(("common", "enter-block-description")),
        "Gigameters" => Some(("common", "gigameters")),
        "Hectometers" => Some(("common", "hectometers")),
        "Hyperlink*" => Some(("common", "hyperlink-star")),
        "Hyperlink..." => Some(("common", "hyperlink-ellipsis")),
        "Invalid character '{invalid_char}' in block name (\\ / : * ? \" < > | = ` are not allowed)" => Some(("common", "invalid-character-in-block-name")),
        "Light Years" => Some(("common", "light-years")),
        "Match block orientation" => Some(("common", "match-block-orientation")),
        "Microinches" => Some(("common", "microinches")),
        "Microns" => Some(("common", "microns")),
        "Mils" => Some(("common", "mils")),
        "Nanometers" => Some(("common", "nanometers")),
        "No objects selected" => Some(("common", "no-objects-selected")),
        "No objects selected. You must select objects to define a block." => Some(("common", "no-objects-selected-you-must-select-objects-to-define-a-block")),
        "Objects" => Some(("common", "objects-title-case")),
        "Parsecs" => Some(("common", "parsecs")),
        "Pick point" => Some(("common", "pick-point")),
        "Retain" => Some(("common", "retain")),
        "Scale uniformly" => Some(("common", "scale-uniformly")),
        "Specify On-screen" => Some(("common", "specify-on-screen")),
        "US Survey Feet" => Some(("common", "us-survey-feet")),
        "to layout" => Some(("common", "to-layout")),
        "{count} objects selected" => Some(("common", "count-objects-selected")),
        _ => None,
    }
}
